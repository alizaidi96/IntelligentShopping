									...
									<ul class="cd-secondary-dropdown is-hidden">
										...
										<li class="has-children">
											...
											<ul class="is-hidden"> 
												...
												<li><a href="products.jsp">Tablets/IPad</a></li>
											</ul>
										</li> 
										<li class="has-children">
										...
										<li class="has-children">
											...
											<ul class="is-hidden"> 
												<li class="go-back"><a href="#">All Electronics</a></li>
												<li><a href="products.jsp">Tv and Accessories</a></li>
												<li><a href="products.jsp">Digital Camera</a></li>
												<li><a href="products.jsp">Gaming</a></li>
												<li><a href="products.jsp">Home Audio and Theater</a></li>
										...
										<li class="has-children">
											...
											<ul class="is-hidden">
												...
												<li><a href="products.jsp">Heaters and Fans</a></li>
											</ul>
										</li>
										<li class="has-children">
											...
											<ul class="is-hidden"> 
												...
												<li><a href="products.jsp">Router and Modem</a></li>
										...
										<li class="has-children">
											...
											<ul class="is-hidden"> 
												...
												<li><a href="products.jsp">Trimmer and Shaver</a></li>
