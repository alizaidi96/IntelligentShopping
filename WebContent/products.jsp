...
<script type="text/javascript">
	function please(str,str1){
		alert("Please Login first");
		location="login.jsp?cat="+str+"&subcat="+str1;
	}
</script>
<%
...
%>
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp?pid=<%=id%>"><img src="admin/product/<%=image1%>" style="height:250px;" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp?pid=<%=id%>"><%=str%></a></h5> 
								<h6><%=pprice%></h6> 
								<form action="#" method="post">
									<button type="button" onclick="please(<%=pcate%>,<%=pscate%>);" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button>
								</form> 
							</div>
						</div> 
					</div>
