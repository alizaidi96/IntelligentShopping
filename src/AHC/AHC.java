...
import ItemFreqFinder.ItemFreq;
import java.util.logging.Level;
import java.util.logging.Logger;


public class AHC extends Observable {

    public static ArrayList<String> list = new ArrayList<String>();

    public static void main(String[] args) throws Exception {
        EditFile fiel = new EditFile();
        transaFile = fiel.path;
        System.out.print("from here " + args.length);
        AHC ap = new AHC();
    }
    ...
    /**
     * by default, AHC is used with the command line interface
     */
     ...
     */
    public AHC(Observer ob) throws Exception {
        usedAsLibrary = true;
        configure();
        this.addObserver(ob);
        go();
    ...
    /**
     * generates the AHC itemsets from a file
     */
    public AHC() {
        configure();
        go();
    ...
    private void foundFrequentItemSet(int[] itemset, int support) {
        ...
        if (usedAsLibrary) {
            ...
            System.out.println(" from here " + Arrays.toString(itemset) + "  (" + ((support / (double) numTransactions)) + " " + support + ")");
            System.out.println(Arrays.toString(itemset).length());

            fre.finalfreq.add(Arrays.toString(itemset));

        }
        System.out.println(fre.finalfreq);
    }
    ...
    private void configure() {
        try {
            // setting transafile
            transaFile = "D:\\workspace\\AdvancedRecommendation\\src\\AHC\\te";
            ...
            Logger.getLogger(AHC.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
